...
def run_canu():
    ...
    command2 = """canu -p r1 -pacbio-raw './output/Sampled_Reads_Yeast/all.fastq' -d 'output/Canu_yeast' genomeSize=12m cnsMemory=32 cnsConcurrency=32 gridEngineThreadsOption='-l ncpus=32' java=$java"""
